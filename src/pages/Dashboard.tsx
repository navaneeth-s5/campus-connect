...
import { HODApprovalPanel } from "@/components/HODApprovalPanel";
import { AssignedWorkload } from "@/components/AssignedWorkload";
      ...
      <div className="space-y-8">
        <div className="rounded-2xl bg-gradient-hero text-primary-foreground p-7 shadow-elegant">
          <div className="text-sm uppercase tracking-wider opacity-80">
            {user.role} {user.isHOD && <span className="ml-2 bg-white/20 px-2 py-0.5 rounded text-[10px] font-bold">HOD ACTIVE</span>}
          </div>
        ...
        <section>
         ...
         <section className="mt-8">
           ...
           <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              ...
              {user?.role === 'faculty' && (
                <Link to="/leaves" className="p-4 rounded-xl border bg-card hover:bg-muted/50 transition-colors flex flex-col items-center justify-center text-center gap-2">
                  <div className="p-3 rounded-full bg-teal-500/10 text-teal-500"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M15 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V7Z"/><path d="M14 2v4a2 2 0 0 0 2 2h4"/></svg></div>
        ...
        <section className="mt-8 mb-12">
          <div className="flex items-center justify-between mb-3">
            <h2 className="text-lg font-semibold flex items-center">
              <UserCog className="mr-2 h-5 w-5 text-primary" /> Campus Leadership Directory
            </h2>
          </div>
